                            ...
                            <div class="htc__grid__top">
                                <div class="htc__select__option">
                                    <select class="ht__select" onchange="location = this.value;">
                                        <option
                                            value="{{ route('products', ['category'=> request()->category, 'sort' => 'new']) }}">
                                            New
                                        </option>
                                        <option
                                            value="{{ route('products', ['category'=> request()->category, 'sort' => 'high_low']) }}">
                                            Price high
                                        </option>
                                        <option
                                            value="{{ route('products', ['category'=> request()->category, 'sort' => 'low_high']) }}">
                                            Price Low
                                        </option>
                                    </select>
                                ...
                                <div class="ht__pro__qun">
                                    <span>Showing {{count($products)}}</span>
                                </div>
                                                            ...
                                                            <li>
                                                                <form action="{{ route('cart.store') }}" method="POST">
                                                                    ...
                                                                    <input type="hidden" name="price"
                                                                           value="{{ $product->price }}">
                                                                    <button class="buttons-add checkout--btn"
                                    ...
                                    <div role="tabpanel" id="list-view" class="single-grid-view tab-pane fade clearfix">
                                        <div class="col-xs-12">
                                            <div class="ht__list__wrap">
                                                        ...
                                                        <div class="htc__list__details">
                                                            ...
                                                            <div class="fr__list__btn">
                                                                <form action="{{ route('cart.store') }}" method="POST">
                                                                    ...
                                                                    <button class="buttons-cart checkout--btn"
                                                                            type="submit" style="margin-top: 10px;">
                                                                        cart
                                                                    </button>
                                                ...
                                                @empty
                                                    <div style="text-align: center">There is no products in this
                                                        category
                                                    </div>
                                                @endforelse
                                            </div>
                                        ...
                                        <div class="htc__best__product">
                                            <div class="htc__best__pro__thumb">
                                                <a href="{{ route('product.show', $product->slug) }}">
                                                    ...
                                                    <img src="{{ asset('storage/'.$product->image)}}"
                                                         onerror="this.src='/images/product/1.jpg'" alt="full-image">
                                                </a>
                                            </div>
